...
export default class Root extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.all([
      ...
      })).catch(() => that.setState({loading: 'error'}));
  }
          ...
          <div className="main-section">
            ...
            <div className="right-column">
              ...
              <div className="right-boxes search-job-box">
                ...
                <span className="job-fav"><span
                  className="fav-num">{this.state.user.info.favorites}</span> Favorites</span>
  ...
  render() {
    return <div>{this.pageLoader()}</div>
  }
}
